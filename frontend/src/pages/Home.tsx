    ...
    return (
        <div className="relative w-full h-screen overflow-hidden bg-black">
            <div className="absolute inset-0">
                {images.map((image, index) => (
                    <div
                        ...
                        className={`absolute inset-0 bg-cover bg-center ${index === currentIndex ? "z-20" : "z-10"
                            }`}
                        style={{
            ...
            <div   ref={addressRef} className="absolute z-30 right-10 bottom-15 md:right-20 md:bottom-15 text-white text-right">
                <span className="block text-[2.6rem] md:text-[3.5rem] 2xl:text-[5rem] text-gray-400 font-retro tracking-wide">
                    {address[currentIndex]?.ad1}
                </span>
                <span className="block text-[2rem] 2xl:text-[4rem] font-montreal font-light text-gray-500">
