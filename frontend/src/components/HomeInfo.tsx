...
const HomeInfo = ({ details, image, className }: HomeInfo) => {
  return (
    <div className={` ${className} p-3 outline-1 outline-blue-300 shadow-[0_12px_24px_rgba(0,0,0,0.2)]   mx-auto md:mx-0 rounded-2xl inline-block max-w-fit`}>
